...
struct Info : MetaModule::ModuleInfoBase {
    ...
    static constexpr std::array<MetaModule::Element, 7> Elements {{
        ...
        makeKnob(67.f,  55.f, "K3", "Knob 3 Yellow"),
        makeKnob(14.f,  90.f, "K4", "Knob 4 Green"),
        makeKnob(40.f,  90.f, "K5", "Knob 5 Blue"),
        makeKnob(67.f,  90.f, "K6", "Knob 6 Purple"),
        makeBtn (40.f, 115.f, "Set", "Next Set"),
    }};
